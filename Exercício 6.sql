...
CREATE TABLE Consulta (
	...
	ID_PACIENTE INTEGER REFERENCES Nutricionista(ID_NUTRICIONISTA) NOT NULL,
	ID_NUTRICIONISTA INTEGER REFERENCES Paciente(ID_PACIENTE) NOT NULL,
...
INSERT INTO Nutricionista (CRN, ESPECIALIDADE, TEMPO_EXPERIENCIA)
	...
	VALUES ('CRN-5/ 2222/P', 'ESPORTES', 8);
...
INSERT INTO Paciente (NOME, DATA_NASCIMENTO, CPF, TELEFONE, EMAIL)
	...
	VALUES('Teste Machado', '01-01-1999', '111.111.111-11', '(48) 9 9999-9999', 'teste@hotmail.com');
...
UPDATE 	Consulta SET ID_PACIENTE = 2 WHERE ID_CONSULTA = 1;